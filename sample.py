...
if __name__ == '__main__':
    ...
    gpt = AbstractTakeawayForClaimTask(engine="gpt-3.5-turbo", openai_wrapper=openai_wrapper)
    ...
    print(gpt(claim=sample_claim2, abstract=sample_abstract))

    print(f"claim3: {sample_claim3}\n")
    print(gpt(claim=sample_claim3, abstract=sample_abstract, is_chat=True))
